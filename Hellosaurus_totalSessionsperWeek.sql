...
SELECT COUNT(*) AS SESSIONS_COUNT, WEEKLY FROM 
( 
SELECT SESSION_ID, DATE_PART('minute', MAX(EVENTS.TIMESTAMP) - MIN(EVENTS.TIMESTAMP)) AS DURATION,
